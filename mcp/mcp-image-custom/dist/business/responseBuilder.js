...
import { ConfigError, FileOperationError, GeminiAPIError, ImageAPIError, InputValidationError, NetworkError, SecurityError, } from '../utils/errors.js';
 ...
 */
const SAFE_CONTEXT_KEYS = ['provider', 'stage', 'statusCode'];
/**
 ...
 */
function buildPublicDetails(context) {
    if (!context)
        return undefined;
    const details = {};
 ...
 */
function resolveMimeType(metadataMimeType, filePath) {
