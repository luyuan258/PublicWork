...
export class StructuredPromptGeneratorImpl {
    ...
    async generateStructuredPrompt(userPrompt, features = {}, inputImageData, purpose, inputImageMimeType) {
        try {
            // Validate input
 ...
 */
export function createStructuredPromptGenerator(textClient) {
