...
export interface ImageClient {
    generateImage(params: ImageApiParams): Promise<Result<GeneratedImageResult, GeminiAPIError | ImageAPIError | NetworkError>>;
}
//# sourceMappingURL=imageClient.d.ts.map