...
export interface TextClient {
    generateText(prompt: string, config?: GenerationConfig): Promise<Result<string, GeminiAPIError | ImageAPIError | NetworkError>>;
    validateConnection(): Promise<Result<boolean, GeminiAPIError | ImageAPIError | NetworkError>>;
}
//# sourceMappingURL=textClient.d.ts.map